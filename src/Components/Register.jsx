...
const Register = () => {
  return (
    <div className='mt-20 m-auto w-1/2'>
        ...
        <Link className='py-3 px-5 w-[500px] flex items-center justify-center text-xl tracking-wider bg-[#3c4242] hover:bg-black text-white max-w-full mx-auto border border-[#c0c0c0] outline-none '>Create</Link>
        ...
        <Link to='/' className='tracking-wide text-[14px]  underline underline-offset-2 uppercase'>return to <span className='font-[600]'>Store</span></Link>
